...
(function () {
    ...
    "undefined" == typeof exports || exports.nodeType
        ? (n._ = h)
        : ('undefined' != typeof module && !module.nodeType && module.exports && (exports = module.exports = h),
        (exports._ = h)),
    (h.VERSION = '1.9.1');
    function y(u, i, n) {
    ...
    (h.template = function (i, n, r) {
        ...
        var t,
            e = RegExp(
                [(n.escape || J).source, (n.interpolate || J).source, (n.evaluate || J).source].join('|') + '|$',
                'g',
            ),
            o = 0,
            a = '__p+=\'';
...
(function (t) {
    ...
    var h,
        ...
        u = function (t, e, n, r, s) {
            ...
            } else if (n && o.test(n)) for (h = n.split(o); a < h.length; a++) e = t(e, h[a], r, s);
            else e = t(e, n, r, s);
            return e;
        };
    (a.on = function (t, e, i) {
    ...
    var l = function (t, e, i, n) {
            if (i) {
                var r = t[e] || (t[e] = []),
                    ...
                    a = n.ctx,
                    o = n.listening;
                o && o.count++, r.push({ callback: i, context: s, ctx: s || a, listening: o });
            }
            return t;
        },
        c = function (t, e, i, n) {
    ...
    (a.off = function (t, e, i) {
        return (
            this._events && (this._events = u(f, this._events, t, e, { context: i, listeners: this._listeners })),
            this
        );
    }),
    ...
    (g.prototype.off = function (t, e) {
        (this.interop
            ? ((this._events = u(f, this._events, t, e, { context: void 0, listeners: void 0 })), this._events)
    ...
    i.extend(m.prototype, a, {
        ...
        destroy: function (t) {
            ...
            return (
                this.isNew() ? i.defer(t.success) : (G(this, t), (a = this.sync('delete', this, t))), r || s(), a
            );
        },
        url: function () {
            ...
            if (null != t) {
                ...
                for (m = 0; m < t.length; m++) {
                    ...
                    if (_) {
                        ...
                        l &&
                                ...
                                (a.push(g), this._addReference(g, e), (u[g.cid] = !0), s.push(g));
                }
                if (f) {
                ...
                if (
                    ...
                    for (m = 0; m < a.length; m++)
                        null != r && (e.index = r + m), (g = a[m]).trigger('add', g, this, e);
                    (d || w) && this.trigger('sort', this, e),
                    (a.length || h.length || o.length) &&
                                ((e.changes = { added: a, removed: h, merged: o }), this.trigger('update', this, e));
                }
                return n ? t[0] : t;
            }
        },
    ...
    (e.sync = function (t, n, r) {
        ...
        if (
            ...
            null != r.data ||
                        ...
                        ((a.contentType = 'application/json'), (a.data = JSON.stringify(r.attrs || n.toJSON(r)))),
            r.emulateJSON &&
    ...
    i.extend(B.prototype, a, {
        ...
        matchRoot: function () {
            return (
                this.decodeFragment(this.location.pathname).slice(0, this.root.length - 1) + '/' === this.root
            );
        },
    ...
    (e.Builder.prototype.createFieldVectors = function () {
        for (
            ...
            for (
                ...
                void 0 === n[x]
                    ? ((m = e.idf(this.invertedIndex[x], this.documentCount)), (n[x] = m))
                    : (m = n[x]),
                (v =
                                (m * ((this._k1 + 1) * w)) /
    ...
    (e.QueryLexer.lexText = function (t) {
        for (;;) {
            ...
            if (92 != r.charCodeAt(0)) {
                ...
                if ('^' == r)
                    return t.backup(), 0 < t.width() && t.emit(e.QueryLexer.TERM), e.QueryLexer.lexBoost;
...
!(function (typedoc) {
    ...
    'undefined' != typeof Backbone &&
            ((typedoc.Events = function () {}), _.extend(typedoc.Events.prototype, Backbone.Events));
                ...
                (FilterItemSelect.prototype.initialize = function () {
                    ...
                    this.$select
                        ...
                        .on(typedoc.pointerUp, 'li', function (e) {
                            _this.$select.removeClass('active'),
                            _this.setValue(($(e.target).attr('data-value') || '').toString());
                        }),
        ...
        return (
            ...
            (MenuHighlight.prototype.onResize = function () {
                for (var anchor, index = 1, count = this.anchors.length; index < count; index++)
                    (anchor = this.anchors[index]).position = anchor.$anchor.offset().top;
            ...
            (MenuHighlight.prototype.onScroll = function (scrollTop) {
                ...
                this.index != index &&
                        (0 < this.index && this.anchors[this.index].$link.removeClass('focus'),
                        (this.index = index),
...
(function (typedoc) {
    ...
    !(function (search) {
            ...
            !(function batch() {
                for (var cycles = 0; cycles++ < 100; )
                    if ((builder.add(rows[pos]), ++pos == length))
                        return (index = builder.build()), setLoadingState(SearchLoadingState.Ready);
                setTimeout(batch, 10);
            })();
        }
        function loadIndex() {
        ...
        function gotoCurrentResult() {
            ...
            0 < $current.length && ((window.location.href = $current.find('a').prop('href')), $field.blur());
        }
        $results
