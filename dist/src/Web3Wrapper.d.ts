...
export default abstract class Web3Wrapper {
    ...
    protected signContractTransaction(transaction: PayableTransactionObject<any> | NonPayableTransactionObject<any> | ContractSendMethod, to: Address | undefined, options: {
    ...
    protected sendTransaction(transaction: ContractSendMethod | PayableTransactionObject<any> | NonPayableTransactionObject<any> | Web3Core.TransactionConfig, to: Address | undefined, options: {
        from: Web3Core.Account;
        value?: number | string | BN;
        gas?: number;
