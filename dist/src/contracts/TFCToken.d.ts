...
export interface TfcToken extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): TfcToken;
    clone(): TfcToken;
    methods: {
        ...
        burnFrom(account: string, amount: number | string): NonPayableTransactionObject<void>;
        ...
        getRoleMember(role: string | number[], index: number | string): NonPayableTransactionObject<string>;
        ...
        mint(to: string, amount: number | string): NonPayableTransactionObject<void>;

        name(): NonPayableTransactionObject<string>;

        one2manyTransfer(tos: string[], amounts: (number | string)[]): NonPayableTransactionObject<boolean>;
